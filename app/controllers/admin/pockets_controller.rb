class Admin::PocketsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pocket.save
        format.html { redirect_to [:admin, @pocket], notice: 'Pocket was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @pocket.update(pocket_params)
        format.html { redirect_to [:admin, @pocket], notice: 'Pocket was successfully updated.' }
  ...
  def destroy
    @pocket.destroy
    respond_to do |format|
      format.html { redirect_to admin_pockets_url, notice: 'Pocket was successfully destroyed.' }
  ...
  private
    ...
    def pocket_params
      params.require(:pocket).permit(:color, :image)
    end
end
