...
class BasesControllerTest < ActionController::TestCase
  ...
  test "should create basis" do
    assert_difference('Base.count') do
      post :create, basis: { color: @basis.color, hoop: @basis.hoop, image: @basis.image, neck: @basis.neck }
    end
  ...
  test "should update basis" do
    patch :update, id: @basis, basis: { color: @basis.color, hoop: @basis.hoop, image: @basis.image, neck: @basis.neck }
    assert_redirected_to basis_path(assigns(:basis))
  end
